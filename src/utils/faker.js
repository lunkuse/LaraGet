...
const fakers = {
  ...
  //   const images = []
  //   for (let i = 0; i < 15; i++) {
  //     images[images.length] = 'image-' + _.random(1, 15) + '.jpg'
  //   }
  ...
  fakeFiles() {
    const files = [
      // { fileName: 'National ID', type: 'Image', size: '1 MB' },
      ...
      { fileName: 'Images', type: 'Folder', size: '1 MB' },
      { fileName: 'Documents', type: 'Empty Folder', size: '4 MB' }
