...
import SlotsTable from "/src/views/appointments/slotsTable.vue";
export default defineComponent({
    ...
    const handleSubmit = () => {
      ...
      if (validate.value.$invalid) {
        ...
        const data = {
          ...
          recallId:this.appointmentTypeselectedData.id,
          slots: {
  ...
  setup() {
    const { t } = useI18n({});
    const injectedData = inject('appointmentTypeselected');
   const appointmentTypeselectedData=inject('appointmentTypeselectedData',);
    ...
    return {
      t,
      injectedData,appointmentTypeselectedData,
      getTimeDifference,
      lang
    };
  },
