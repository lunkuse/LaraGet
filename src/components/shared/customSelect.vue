<template>
  <div class="custom-select2" :tabindex="tabindex" @blur="open = false" :icon="icon">
...
<script>
  import FilterDropdown from '../../reports/components/FilterDropdown.vue';
export default {
  components: {
    FilterDropdown
  },
...
.custom-select2 {
  ...
  height: 40px;
  line-height: 35px;
  background-color: #FF782F !important;
