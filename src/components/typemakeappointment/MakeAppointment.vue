                      ...
                      <div class="box">
                        <div class="col-span-12 xl:col-span-6">
                          ...
                          <div class="mt-3">
                            ...
                            <input
                              v-if="appointmenttypeid"
                              type="text"
                              class="form-control"
                              placeholder="name"
                              id="name-product"
                              :value="appointmenttypeid.title"
                              disabled
                            />
                          </div>
                          ...
                          <div class="mt-3">
                            ...
                            <Litepicker
                              ...
                              class="w-full intro-x form-control bg-white py-3 px-4 block border-gray-200 focus:border-gray-500"
                          ...
                          <div class="mt-3">
                            ...
                            <span
                              class="text-xs px-1 border text-slate-600 dark:border-darkmode-100/40 dark:text-slate-300 mr-1 font-semibold"
                            >{{newStartTime}}-{{newEndTime}}</span>
                            <br />
                            <div
...
export default defineComponent({
  components: {},
  props: {
    appointmenttypeid: { type: Object }
  },
  watch: {
    appointmenttypeid: function() {
      this.selected_appointment_type = this.appointmenttypeid.id
      console.log('my type', this.selected_appointment_type)
      ...
      this.appointmentData = this.appointment_type.filter(
        selectedType => selectedType.id == this.appointmenttypeid?.id
      )[0]
      Object.assign(
      ...
      // default value for date with start date
