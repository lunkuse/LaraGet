<template>
  ...
  <div class="bg-white dark:bg-dark-1 h-full bg-transparent overflow-hidden ">
    ...
    <div id="contentdiv" class="parent-container flex flex-col ">
      <div
        class="grid grid-cols-6  mt-2 border-b 
      ...
      >
        <div class="flex form-check custom-checkbox mx-1">
          <div>
            ...
            />
          </div> <span class="ml-1">{{ $t('translation.transaction_text') }}</span>
         
        </div>
       
        <div class=" ml-4"> {{ $t('translation.amount_text') }}</div>

       
        <div class="ml-2">{{ $t('translation.status_text') }}</div>
        <div class="">{{ $t('translation.date_text') }}</div>
                <div class="ml-2">{{ $t('translation.method_text') }}</div>
      ...
      <!-- content container header -->
      <div class="min-h-full w-full mt-1 scrollContent pb-20" ref="scrollContainer">
        <div
...
import InvoiceListItem from "./TransactionListItem.vue";
