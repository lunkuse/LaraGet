    ...
    <div id="contentdiv" class="parent-container flex flex-col">
      ...
      <div class="min-h-full w-full mt-1 scrollContent" ref="scrollContainer">
        ...
        <div v-if="emails?.length > 0">
          ...
          <div v-else>
          <div v-if="!isLoading" class="flex flex-col items-center justify-center h-min-screen">
...
import Observer from "./../emails/Observer.vue";
  ...
  setup(props, { emit }) {
    ...
    const onSelected = (email, isChecked) => {
      if (isChecked) {
        ...
        checkedEmails.value.splice(checkedEmails.value.indexOf(email?.id), 1);
      }
