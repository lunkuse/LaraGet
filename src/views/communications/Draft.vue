      ...
      <div class="grid grid-cols-12 gap-6 mt-8">
        <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
          ...
          <div class="intro-y box bg-theme-36 p-5 mt-6">
            <router-link to="/dashboard/compose-email">
              <button
                type="button"
                class="btn text-slate-600 dark:text-slate-800 w-full bg-white dark:bg-darkmode-300 dark:border-darkmode-300 mt-1"
              >
                <svg
            ...
            <div class="border-t border-white/10 dark:border-darkmode-400 mt-6 pt-6 text-white">
              <router-link to="/dashboard/communication">
                <a href class="flex items-center px-3 py-2 rounded-md flex">
                  ...
                  <p v-if="translations.inbox_txt">{{translations.inbox_txt}}</p>
                  <p v-else>Inbox</p>
                  <p
                    class="text-xs px-1 rounded-full bg-white text-theme-43 mr-1 ml-auto"
                  >{{inboxCount}}</p>
                </a>
              </router-link>
              ...
              <router-link to="/dashboard/draft-email">
                <a
                  href
                ...
                >
                  ...
                  <p v-if="translations.draft_txt">{{translations.draft_txt}}</p>
                  <p v-else>Draft</p>
                </a>
              </router-link>
              <router-link to="/dashboard/sent-email">
                <a href class="flex items-center px-3 py-2 mt-2 rounded-md">
                  ...
                  <p v-if="translations.sent_txt">{{translations.sent_txt}}</p>
                  <p v-else>Sent</p>
                </a>
              </router-link>
              <a href class="flex items-center px-3 py-2 mt-2 rounded-md">
                ...
                <p v-if="translations.trash_txt">{{translations.trash_txt}}</p>
                <p v-else>Trash</p>
              </a>
            </div>
            <div
        ...
        <div class="col-span-12 lg:col-span-9 2xl:col-span-10">
          <div class="intro-y inbox box mt-5">
            ...
            >
              <h2 v-if="translations.draft_txt">{{translations.draft_txt}}</h2>
              <h2 v-else>Draft</h2>
            </div>
            ...
            <div class="overflow-x-auto relative mt-5">
              ...
              >
                ...
                <span>We are loading your Emails...</span>
              </span>
                  ...
                  >
                    ...
                    <tbody>
                      <tr
                        ...
                        :class="StatusClassunread(clientemail.read_at)"
                      >
                      ...
                      params: { emailId: clientemail.id , messageId:clientemail.id}
                    }"
                            class="flex"
                          >
                            <Avatar
                              v-bind:initials="clientemail.first_name + clientemail.last_name"
                              class="rounded-full"
                            />
                            {{clientemail.first_name}} {{clientemail.last_name}}
                          </router-link>
                        </td>
                      ...
                      params: { emailId: clientemail.id , messageId:clientemail.id}
                          ...
                          >
                            <div style="height:100%; width:100%">
                              <span>{{ moment(clientemail.created_at).fromNow()}}</span>
                        ...
                        <td class="whitespace-nowrap">
                          <a
                            href="javascript:;"
                            data-toggle="modal"
                            data-target="#static-backdrop-modal-preview-resend"
                          >Resend</a>
                        </td>
                        <!-- <a
            href="javascript:;"
            ...
            class="btn mr-1 mb-2 bg-theme-32 text-white"
                        ...
                        <!-- <td class="whitespace-nowrap" :class="StatusClass(notification.status)">
                  <a
                    href="javascript:;"
                    data-toggle="modal"
...
import Resend from '@/components/emailing/composeBoxDraft.vue'
    ...
    getEmail() {
      ...
      axios
        ...
        .then(res => {
          ...
          this.clientemails = res.data.payload
          console.log('draft emails', this.clientemails)
          Object.assign(this.clientemails, res.data.payload)
          setTimeout(() => {
            $.extend(true, $.fn.dataTable.defaults, {
              ...
              initComplete: function() {
                ...
                //  textsearch.removeClass('dataTables_filter');
              }
            })
