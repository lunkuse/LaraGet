        ...
        <div>
          <div>
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
              ...
              <div  @click="viewTheRecalledAppointments" class="w-full sm:w-auto flex mt-4 sm:mt-0">
                <a
              ...
              <div class="modal-content">
                ...
                <div class="modal-body p-10">
                  <div class="intro-y flex items-center mt-8">
                    <h2
                      class="text-lg font-medium mr-auto text-black dark:!text-white"
                    >
...
<script>
import { defineComponent, toRaw, reactive, toRefs, inject, ref,provide } from 'vue'
...
export default defineComponent({
  ...
  data() {
    ...
    const handleSubmit = () => {
      ...
      if (validate.value.$invalid) {
        ...
        //     }
        //   })
        const url = 'patients/appointments/create'
        try {
  ...
  // provide() {
  //   return {
  //     showrecalls: this.isDisplayRecals,
  //   };
  // },
  methods: {
    moment,
       viewTheRecalledAppointments(){
    ...
    downloadPDF() {
      axios
        .get('/patients/appointments/download-pdf-appointments', {
          responseType: 'blob'
        })
