...
<div>
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
      ...
      <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        <!-- <button class="btn btg-theme-36 text-white shadow-md mr-2">Start New Chat</button> -->
          ...
          <div class="dropdown-menu w-40">
            <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
              <a
                ...
                "
              >
                <UsersIcon class="w-4 h-4 mr-2" /> New Chat
              </a>
              <a
                href=""
                class="
    ...
    <div class="intro-y chat grid grid-cols-12 gap-5 mt-5">
      ...
      <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
        <div class="intro-y pr-1">
          <div class="box p-2"  style="display:none">
            <div class="chat__tabs nav nav-tabs justify-center" role="tablist" style="display:none">
              <a
                id="chats-tab"
                data-toggle="tab"
                data-target="#chats"
                href="javascript:;"
                class="flex-1 py-2 rounded-md text-center  text-gray-800"
                role="tab"
                aria-controls="chats"
                aria-selected="true"
                >Chats</a
          ...
          >
            <div class="pr-1">
              <div class="box px-5 pt-5 pb-5 lg:pb-0 mt-5">
                <div class="relative text-gray-700 dark:text-gray-300 focus:border-theme-36">
                  <input
                    type="text"
                    class="
                      form-control
                    ...
                    >
                      <div class="w-10 h-10 flex-none image-fit rounded-full">
                        <img
                          ...
                          class="rounded-full"
                          :src="
                            require(`@/assets/images/${faker.photos[0]}`)
                ...
                <div class="ml-2 overflow-hidden">
                  <div class="flex items-center">
                    ...
                    <div class="text-xs text-gray-500 ml-auto">
                      <!-- We need to book your in as soon as possible -->
                      {{ faker.times[0] }}
                    </div>
                  </div>
              ...
              <div class="box p-5 mt-5">
                ...
                >
                  <div>
                    ...
                    <div class="mt-1">+31 19 23 62 24 34</div>
                  </div>
          ...
          <div v-if="chatBox" class="h-full flex flex-col">
            ...
            <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
              ...
              <div class="chat__box__text-box flex items-end float-right mb-4">
                ...
                >
                  Lorem ipsum sit amen dolor, lorem ipsum sit amen dolor
                  <div class="mt-1 text-xs text-theme-1">1 mins ago</div>
                </div>
                <div
                  class="
                    w-10
              ...
              <div class="chat__box__text-box flex items-end float-right mb-4">
                ...
                >
                  Lorem ipsum sit amen dolor, lorem ipsum sit amen dolor
                  <div class="mt-1 text-xs text-theme-1">59 secs ago</div>
                </div>
                <div
                  class="
                    w-10
              ...
              <div class="chat__box__text-box flex items-end float-right mb-4">
                ...
                >
                  Lorem ipsum
                  <div class="mt-1 text-xs text-theme-1">1 secs ago</div>
                </div>
                <div
                  class="
                    w-10
