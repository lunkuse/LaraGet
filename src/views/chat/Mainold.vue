...
<template>
  ...
  <div style="">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
      <h2 class="text-lg font-medium mr-auto text-gray-800">Chat</h2>
              ...
              >
                ...
                <div class="ml-2 overflow-hidden">
                  <div class="flex items-center">
                    <a href="javascript:;" class="font-medium">{{ currentUser.first_name }}</a>
              ...
              <div class="box px-5 py-10 mt-5">
                ...
                >
                  <img
                    alt="metadent"
                    :src="
                      require(`@/assets/images/${$f()[0].photos[0]}`).default
                    "
                  />
                </div>
              ...
              <div class="chat__box__text-box flex items-end float-right mb-4">
                ...
                >
                  <img
                    ...
                    class="rounded-full"
                    :src="
                      require(`@/assets/images/${$f()[1].photos[0]}`).default
                    "
                  />
                </div>
              </div>
