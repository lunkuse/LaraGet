          ...
          >
            ...
            >
              ...
              <div class="intro-x mt-8">
                ...
                />
                <!-- <small class="text-theme-6 mt-2">{{ firstNameError }}</small> -->
                <ErrorMessage
                  name="first_name"
                ...
                <Field
                  type="text"
                  name="last_name"
                  class="intro-x login__input form-control py-3 px-4 border-gray-200 focus:border-theme-36 block mt-4"
                  v-model="last_name"
                  :placeholder="`${$t('translation.last_name_text')}`"
                />
                <ErrorMessage
                  name="last_name"
                  style="font-size: 13px"
                ...
                <!-- phone -->
                <div
                  class="input-group mt-2 p-0 grid grid-flow-col grid-cols-1 md:grid-cols-1 sm:grid-cols-1 lg:grid grid-cols-[20%_80%] xl:grid grid-cols-[20%_80%] 2xl:grid grid-cols-[20%_80%]"
                >
                  ...
                  <Field
                    ...
                    type="number"
                    name="phone"
                    class="intro-x login__input form-control border-gray-200 focus:border-theme-36 block col-span-4"
                    v-model="phoneCountryCode.phone"
                    placeholder="e.g 678647465"
                    maxlength="9"
                  />
                </div>
                ...
                <Field
                  ...
                  name="address"
                  class="intro-x login__input form-control py-3 px-4 border-gray-200 focus:border-theme-36 block mt-4"
                  :placeholder="`${$t('translation.address_text')}`"
                  v-model="address"
                  value=""
                />
                <ErrorMessage
                ...
                <div class="flex">
                  <div class="flex w-full mt-4">
                    ...
                    />
                    <div
                      class="z-30 w-10 flex items-center justify-center text-gray-600 dark:bg-dark-1 dark:border-dark-4 -mr-1 border-gray-300 focus:border-theme-36"
                    >
                      <span class="px-4 input-group-text">DOB</span>
                    </div>
                  </div>
                </div>
                <ErrorMessage
                ...
                <!-- <div class="flex">
                  <div class="flex w-full mt-4">
                    ...
                    />
                    <div
                      class="text-theme-32 z-30 w-10 flex items-center justify-center text-gray-600 dark:bg-dark-1 dark:border-dark-4 -mr-1 border-gray-300 focus:border-theme-36"
                    >
                      <i
                ...
                <!-- <div class="flex">
                  <div class="flex w-full mt-4">
                    <Field
                      ...
                      :placeholder="
                        translations?.password_confirmation_text ??
                ...
                <div class="flex">
                  ...
                  >
                    <Field
                      ...
                      name="password_confirmation"
                      :placeholder="`${$t(
                        'translation.password_confirmation_text'
                      )}`"
                      :type="typeconfirm"
                      value
                      style="box-shadow: 0px 3px 5px #00000007"
                ...
                <div class="intro-y col-span-12 sm:col-span-6 mt-3">
                  <!-- <div class="intro-y input-group-text w-full"> -->
                  <TomSelect
                    class="w-auto col-span-1 focus:border-theme-36"
                    id="gender"
