<template>
  ...
  >
    ...
    <div
      class="grid grid-cols-1 2xl:grid-cols-3 xl:grid-cols-2 lg:grid-cols-3 gap-2 pt-6"
    >
      <!-- business name -->
      <div class="flex flex-col">
      ...
      <!-- business account -->
      <div class="flex flex-col">
        <label class="createFormLabel" for="">Business Account </label>
        <Field
          class="intro-x login__input form-control py-3 px-4 border-gray-200 focus:border-theme-36 block"
      ...
      <div class="flex flex-col">
        <label class="createFormLabel" for="business_doc"
        ...
        />
        <label
          class="intro-x login__input form-control py-3 px-4 border-gray-200 focus:border-theme-36 block cursor-pointer"
          for="business_doc"
        >
          Choose Files
        </label>
        <div id="selectedFiles" class="text-theme-6">
          Selected Files:
          <ul>
