  ...
  >
    ...
    >
      ...
      <div class="flex flex-col">
        ...
        />
        <ErrorMessage name="BSN" style="font-size: 13px" class="text-theme-6" />
      </div>
  ...
  <div
    ...
    >
      <div class="flex flex-col">
        ...
        <TomSelect v-model="selectedInsurer" class="w-full" id="patientInsurer">
          <option value>
            {{ $t("translation.forms.patientInsurer") }}
          </option>
          <option
        ...
        <div class="hidden">
          <Field
            v-model="formValues.insuranceUzoviCode"
            name="insuranceUzoviCode"
          />
        </div>
        <ErrorMessage
    ...
    <div class="intro-x mt-5 xl:mt-8 text-center justify-center">
      <button
        class="btn py-3 px-4 mr-auto align-top bg-theme-32 text-white"
        type="submit"
      >
        <LoadingIcon
          v-if="loading"
...
const firstName = ref("");
const TelephoneCode=ref( "31")
const MobileCode=ref( "31")
const telephoneNumber = ref( "31")
...
const documentType = ref(formValues.value.documentType);
...
const getHomeDetails = async (field, value) => {
  ...
  if (field === "ext") {
    ...
    if (address.value) {
      ...
      country_name.value = address.value.country;
...
const schema = yup.object().shape({
  ...
  email: yup.string().email(t("translation.errors.invalidEmail"))
  ...
  houseNumber: yup
   ...
   street: yup
    ...
    postalCode: yup
        ...
        .matches(
            /^[0-9]{4}[a-zA-Z]{2}/gm,
            t('translation.errors.codeFormat')
        ),
  ...
  // phone: yup
  //   .string()
  //   .required(t("translation.phonenumberReq uired"))
  //   .matches(phoneRegExp, t("translation.phonenumberNotValid")),
  // address: yup.string(),
  // email: yup.string().email(t("translation.invalidEmailFormat")),
