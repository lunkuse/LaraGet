...
<template>
  <!-- <div class="left-24 right-0 px-2 bottom-2 overflow-auto space-y-1 flex flex-col"
    id="perio-chart"> -->
    <div class="left-24 right-0 px-2 bottom-2 overflow-auto space-y-1 flex flex-col w-full h-full"
    id="perio-chart">
    ...
    <!-- <div id="PrintPerio" class="w-full"> -->
      <div class="ml-24 h-auto p-0.5 flex flex-none space-x-2 relative">
        <div
          class="absolute w-24 pl-1 px-0.5 py-1.5 space-y-0.5 flex flex-col text-black -left-28 text-xs bottom-0 -top-1">
          <div class="w-full h-6 border border-gray-300 whitespace-nowrap flex items-center px-0.5 text-xs"></div>
          <div class="w-full h-6 border border-gray-300 whitespace-nowrap flex items-center px-0.5 text-xs">
            Mobility
          </div>
          <div class="w-full h-6 border border-gray-300 whitespace-nowrap flex items-center px-0.5 text-xs">
            Furcation
          ...
          <div class="w-full h-20 whitespace-nowrap flex items-center pl-1 px-0.5 text-base font-semibold">
            Buccal
          </div>
        </div>
        <div class="w-full h-full flex border-t border-b border-l border-gray-300">
          <div
            ...
            class="border-r border-gray-300 h-full space-y-0.5" :id="`tooth-selectable-f-${tooth.toothNumber}`" v-for="tooth in leftUpperJaw.filter((tooth) => displayedLeftUpperJaw.includes(tooth.toothNumber.toString()))" :key="tooth">
            <div
              class="w-full h-6 text-xs flex justify-center items-center cursor-pointer">
              <span v-if="treatmentBlob[tooth.toothNumber].hasOwnProperty('isPrimary')">{{ tooth.toothNumber }}</span><span v-else>{{ tooth.infantToothNumber}}</span>
            </div>
            <div class="w-full h-auto p-0 space-y-0.5 block" :id="`missing-f-${tooth.toothNumber}`">
              <div class="h-6 w-full px-0.5">
                <input disabled  type="number" max="3" min="0" :id="`mobility-f-${tooth.toothNumber}`"
                   class="w-full h-full bg-gray-200" />
              </div>
              <div v-if="[18, 17, 16, 28, 27, 26].includes(tooth.toothNumber)" class="w-full h-6 p-0.5">
                <div
              ...
              <div v-if="![18, 17, 16, 28, 27, 26].includes(tooth.toothNumber)" class="h-6 w-full border-b">
              </div>
              <div class="w-full h-6 flex items-center justify-center">
                <input disabled  type="checkbox" :id="`implant-f-${tooth.toothNumber}`"
                   class="w-3 h-3 border bg-gray-200" />
              </div>
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <div class="w-1/3 h-full border bg-gray-200 cursor-pointer"
                  :id="`bleeding-f-left-${tooth.toothNumber}`" @click.prevent="
                    indicateBleeding(
                      'front',
                      'left',
                  ...
                  "></div>
                <div class="w-1/3 h-full border bg-gray-200 cursor-pointer"
                  :id="`bleeding-f-center-${tooth.toothNumber}`" @click.prevent="
                    indicateBleeding(
                      'front',
                      'center',
                  ...
                  "></div>
                <div class="w-1/3 h-full border bg-gray-200 cursor-pointer"
                  :id="`bleeding-f-right-${tooth.toothNumber}`" @click.prevent="
                    indicateBleeding(
                      'front',
                      'right',
              ...
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <div class="w-1/3 h-full border bg-gray-200  cursor-pointer"
                  :id="`plaque-f-left-${tooth.toothNumber}`" @click.prevent="
                    indicatePlaque(
                      'front',
                      'left',
                  ...
                  "></div>
                <div class="w-1/3 h-full border bg-gray-200  cursor-pointer"
                  :id="`plaque-f-center-${tooth.toothNumber}`" @click.prevent="
                    indicatePlaque(
                      'front',
                      'center',
                  ...
                  "></div>
                <div class="w-1/3 h-full border bg-gray-200  cursor-pointer"
                  :id="`plaque-f-right-${tooth.toothNumber}`" @click.prevent="
                    indicatePlaque(
                      'front',
                      'right',
              ...
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <input disabled  type="number" value="0" :id="`gingival-input-f-left-${tooth.toothNumber}`" @keyup.prevent="
                ...
                <input disabled  type="number" value="0" :id="`gingival-input-f-center-${tooth.toothNumber}`" @keyup.prevent="
                  indicateGingivalMargin(
                    $event,
                    'front',
                    'center',
                ...
                " class="w-1/3 h-full border" />
                <input disabled  type="number" value="0" :id="`gingival-input-f-right-${tooth.toothNumber}`" @keyup.prevent="
                  indicateGingivalMargin(
                    $event,
                    'front',
                    'right',
              ...
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <input disabled  type="number" value="0" :id="`probing-input-f-left-${tooth.toothNumber}`" @keyup.prevent="
                ...
                " class="w-1/3 h-full border" />
                <input disabled  type="number" value="0" :id="`probing-input-f-center-${tooth.toothNumber}`" @keyup.prevent="
                  indicateProbingDepth(
                    $event,
                    'front',
                    'center',
                ...
                " class="w-1/3 h-full border" />
                <input disabled  type="number" value="0" :id="`probing-input-f-right-${tooth.toothNumber}`" @keyup.prevent="
                  indicateProbingDepth(
                    $event,
                    'front',
                    'right',
        ...
        <div class="w-full h-full flex border-t border-b border-l border-gray-300">
          ...
          :id="`tooth-selectable-f-${tooth.toothNumber}`" v-for="tooth in rightUpperJaw.filter((tooth) => displayedrRightUpperJaw.includes(tooth.toothNumber.toString()))" :key="tooth">
            <div
      ...
      <div class="ml-24 h-auto p-0.5 flex flex-grow-0 space-x-2 relative">
        <div
          class="absolute w-24 pl-1 px-0.5 py-1.5 space-y-0.5 flex flex-col-reverse text-black -left-28 text-xs bottom-0 -top-1">
        ...
        <div class="w-full h-full flex border-t border-b border-l border-gray-300">
          <div
          :class="[ (displayedLeftUpperJaw.length === 5) ? 'w-1/5' : 'w-1/8']"
          class="border-r border-gray-300 h-full space-y-0.5 flex flex-col-reverse flex-grow-0" :id="`tooth-selectable-b-${tooth.toothNumber}`" v-for="tooth in leftUpperJaw.filter((tooth) => displayedLeftUpperJaw.includes(tooth.toothNumber.toString()))" :key="tooth">
            <div
            ...
            <div class="w-full h-auto p-0 space-y-0.5 flex flex-col-reverse" :id="`missing-b-${tooth.toothNumber}`">
              <div class="flex space-x-0.5 p-0.5" :id="`furcation-b-${tooth.toothNumber}`" v-if="[18, 17, 16, 28, 27, 26].includes(tooth.toothNumber)">
                ...
                " :id="`furcation-b-${tooth.toothNumber}`" class="w-1/2 h-6 border bg-gray-200 flex items-center justify-center">
              ...
              <div class="h-6 w-full border-t border-b m-0.5" v-if="![18, 17, 16, 28, 27, 26].includes(tooth.toothNumber)">
              </div>
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <div class="w-1/3 h-full border bg-gray-200 cursor-pointer"
                  :id="`bleeding-b-left-${tooth.toothNumber}`" @click.prevent="
                    indicateBleeding(
                      'back',
                      'left',
                  ...
                  "></div>
                <div class="w-1/3 h-full border bg-gray-200 cursor-pointer"
                  :id="`bleeding-b-center-${tooth.toothNumber}`" @click.prevent="
                    indicateBleeding(
                      'back',
                      'center',
                  ...
                  "></div>
                <div class="w-1/3 h-full border bg-gray-200 cursor-pointer"
                  :id="`bleeding-b-right-${tooth.toothNumber}`" @click.prevent="
                    indicateBleeding(
                      'back',
                      'right',
              ...
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <div class="w-1/3 h-full border bg-gray-200  cursor-pointer"
                  :id="`plaque-b-left-${tooth.toothNumber}`" @click.prevent="
                    indicatePlaque(
                      'back',
                      'left',
                  ...
                  "></div>
                <div class="w-1/3 h-full border bg-gray-200  cursor-pointer"
                  :id="`plaque-b-center-${tooth.toothNumber}`" @click.prevent="
                    indicatePlaque(
                      'back',
                      'center',
                  ...
                  "></div>
                <div class="w-1/3 h-full border bg-gray-200  cursor-pointer"
                  :id="`plaque-b-right-${tooth.toothNumber}`" @click.prevent="
                    indicatePlaque(
                      'back',
                      'right',
              ...
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <input disabled  type="number" value="0" :id="`gingival-input-b-left-${tooth.toothNumber}`" @keyup.prevent="
                  indicateGingivalMargin(
                    $event,
                    'back',
                    'left',
                ...
                " class="w-1/3 h-full border" />
                <input disabled  type="number" value="0" :id="`gingival-input-b-center-${tooth.toothNumber}`" @keyup.prevent="
                  indicateGingivalMargin(
                    $event,
                    'back',
                    'center',
                ...
                " class="w-1/3 h-full border" />
                <input disabled  type="number" value="0" :id="`gingival-input-b-right-${tooth.toothNumber}`" @keyup.prevent="
                  indicateGingivalMargin(
                    $event,
                    'back',
                    'right',
              ...
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <input disabled  type="number" value="0" :id="`probing-input-b-left-${tooth.toothNumber}`" @keyup.prevent="
                  indicateProbingDepth(
                    $event,
                    'back',
                    'left',
                ...
                " class="w-1/3 h-full border" />
                <input disabled  type="number" value="0" :id="`probing-input-b-center-${tooth.toothNumber}`" @keyup.prevent="
                  indicateProbingDepth(
                    $event,
                    'back',
                    'center',
                ...
                " class="w-1/3 h-full border" />
                <input disabled  type="number" value="0" :id="`probing-input-b-right-${tooth.toothNumber}`" @keyup.prevent="
                  indicateProbingDepth(
                    $event,
                    'back',
                    'right',
        ...
        <div class="w-full h-full flex border-t border-b border-l border-gray-300">
          <div
          :class="[ (displayedLeftUpperJaw.length === 5) ? 'w-1/5' : 'w-1/8']"
          class="border-r border-gray-300 h-full space-y-0.5 flex flex-col-reverse flex-grow-0" :id="`tooth-selectable-b-${tooth.toothNumber}`" v-for="tooth in rightUpperJaw.filter((tooth) => displayedrRightUpperJaw.includes(tooth.toothNumber.toString()))" :key="tooth">
            <div
      ...
      <div class="ml-24 h-auto p-0.5 flex flex-none space-x-2 relative">
        ...
        <div class="w-full h-full flex border-t border-b border-l border-gray-300">
          <div
          :class="[ (displayedLeftUpperJaw.length === 5) ? 'w-1/5' : 'w-1/8']"
          class="border-r border-gray-300 h-full space-y-0.5" :id="`tooth-selectable-f-${tooth.toothNumber}`" v-for="tooth in leftLowerJaw.filter((tooth) => displayedLeftLowerJaw.includes(tooth.toothNumber.toString()))" :key="tooth">
            <div
            ...
            <div class="w-full h-auto p-0 space-y-0.5 block" :id="`missing-f-${tooth.toothNumber}`">
              ...
              <div v-if="[48, 47, 46, 38, 37, 36].includes(tooth.toothNumber)" class="w-full h-6 p-0.5">
                <div @click.prevent="
                  indicateFurcation(
              ...
              <div v-if="![48, 47, 46, 38, 37, 36].includes(tooth.toothNumber)" class="h-6 w-full border-b">
              </div>
              <div class="w-full h-6 flex items-center justify-center">
                <input disabled  type="checkbox" :id="`implant-f-${tooth.toothNumber}`"
                   class="w-3 h-3 border bg-gray-200" />
        ...
        <div class="w-full h-full flex border-t border-b border-l border-gray-300">
          <div
          :class="[ (displayedLeftUpperJaw.length === 5) ? 'w-1/5' : 'w-1/8']"
          class="border-r border-gray-300 h-full space-y-0.5" :id="`tooth-selectable-f-${tooth.toothNumber}`" v-for="tooth in rightLowerJaw.filter((tooth) => displayedRightLowerJaw.includes(tooth.toothNumber.toString()))" :key="tooth">
            <div
      ...
      <div class="ml-24 h-auto p-0.5 flex flex-grow-0 space-x-2 relative">
        ...
        <div class="w-full h-full flex border-t border-b border-l border-gray-300">
          ...
          :id="`tooth-selectable-b-${tooth.toothNumber}`"
            v-for="tooth in leftLowerJaw.filter((tooth) => displayedLeftLowerJaw.includes(tooth.toothNumber.toString()))" :key="tooth">
            <div
            ...
            <div class="w-full h-auto p-0 flex flex-col-reverse flex-grow-0 space-y-0.5" :id="`missing-b-${tooth.toothNumber}`">
              ...
              <div class="h-6 w-full border-t border-b m-0.5" v-if="![48, 47, 46, 38, 37, 36].includes(tooth.toothNumber)">
              </div>
              <div class="w-full h-6 px-0.5 space-x-0.5 flex">
                <div class="w-1/3 h-full border bg-gray-200 cursor-pointer"
                  :id="`bleeding-b-left-${tooth.toothNumber}`" @click.prevent="
        ...
        <div class="w-full h-full flex border-t border-b border-l border-gray-300">
          ...
          class="border-r border-gray-300 h-full space-y-0.5 flex flex-col-reverse flex-grow-0"
          :id="`tooth-selectable-b-${tooth.toothNumber}`"
            v-for="tooth in rightLowerJaw.filter((tooth) => displayedRightLowerJaw.includes(tooth.toothNumber.toString()))" :key="tooth">
            <div
...
<script setup>
import { ref, onMounted, onBeforeMount, inject, computed, watch} from 'vue';
...
// const isMissing = activeTreatment?.value?.missing.includes(toothNumber);
const isMissing = activeTreatment?.value?.missing.includes(toothNumber);
...
console.log('we are here 111', treatmentBlob.value)



console.log('final missing2', missing)
  ...
  // eslint-disable-next-line radix
  ctx.lineTo(canvas.width * 0.5, canvas.height - 200 + parseInt(centerGingivalValue) * 10);
  // eslint-disable-next-line radix
  ctx.lineTo(canvas.width, canvas.height - 200 + parseInt(rightGingivalValue) * 10);
  ...
  ctx.beginPath();
  // eslint-disable-next-line radix
  ctx.moveTo(0, canvas.height - 200 + ((parseInt(leftProbingValue) - parseInt(leftGingivalValue)) * -10));
  // eslint-disable-next-line radix
  ctx.lineTo(canvas.width * 0.5, canvas.height - 200 + (parseInt(centerProbingValue) - parseInt(centerGingivalValue)) * -10);
  // eslint-disable-next-line radix
  ctx.lineTo(canvas.width, canvas.height - 200 + (parseInt(rightProbingValue) - parseInt(rightGingivalValue)) * -10);
  // ctx.lineTo(canvas.width, canvas.height - 200);
  // eslint-disable-next-line radix
  ctx.lineTo(canvas.width, canvas.height - 200 + parseInt(rightGingivalValue) * 10);
  // eslint-disable-next-line radix
  ...
  if (derivedTreatmentBlobLength !== 0) {
    ...
    toothNumbers.forEach((tooth) => {
        console.log('perio tooth2', tooth)
...
let image = new Image()
     console.log('treatmentBlob? value mmm',activeTreatment?.value?.missing)
  if (!treatmentBlob?.value?.missing.includes(toothNumber)) {
        if (!treatmentBlob?.value?.missing.includes(toothNumber)) {
          image.src = images[toothImage][imageExtension];
          console.log(
...
function getTreatment() {
  ...
  axios
    ...
    .then(res => {
      ...
      sections = JSON.parse(client_treatments)
      ...
      Object.assign(activeTreatment.value, client_treatments_all)
       Object.assign(missing, sections.missing)
       missing.value=JSON.parse(activeTreatment.value.tooth_sections).missing
      console.log('activeTreatment activeTreatment',  missing)
    //   console.log('activeTreatment activeTreatment', JSON.parse(activeTreatment.value.tooth_sections).missing)
...
watch(treatmentBlob?.value, () => {
   Object.assign(treatmentBlob.value, sections)
   console.log('treatmentBlob treatmentBlob treatmentBlob', treatmentBlob)
    //   Object.assign(activeTreatment.value, client_treatments_all)
    //    Object.assign(missing, sections.missing)
...
onBeforeMount(() => {
  ...
  console.log('my treatmentBlob', treatmentBlob);
  // if (age.value < 13) {
  //   isInfant.value = true;
...
onMounted(() => {
  ...
  axios
    ...
    .then(res => {
        console.log('we are here 777', activeTreatment)
      const client_treatments_all = res.data.payload[0]
      ...
      console.log('about', activeTreatment)
    //   console.log('activeTreatment activeTreatment', JSON.parse(activeTreatment.value.tooth_sections).missing)
