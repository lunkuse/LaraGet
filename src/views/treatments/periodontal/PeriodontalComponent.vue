...
const reRenderChart = (_toothNumber, canvasId, face) => {
  ...
  axios
   ...
   console.log('new treatments up again', activeTreatment.value)
  ...
  const isMissing = treatmentone.missing.includes(toothNumber);
...
const treatment = activeTreatment.value
 console.log('get treatments first ', treatment);
...
function getTreatment() {
  ...
  axios
    ...
    .then(res => {
      ...
      Object.assign(treatmentBlob.value, sections)
      Object.assign(activeTreatment.value, sections)
console.log('new treatments1', activeTreatment.value)
      if (res.data.success === false) {
        console.log('expired session')
        this.$store.dispatch('auth/logout')
        this.$router.push('/login')
