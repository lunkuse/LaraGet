...
<template>
  <div>
    ...
    <div class="flex overflow-auto w-full h-full" id="context-close">
      ...
      >
        <ul class="flex flex-row justify-center w-full" v-show="isUpperJawVisible">
          <li
          ...
          >
            ...
            <p v-if="!isInfant" class="group-hover:text-white">{{ tooth.toothNumber }}</p>
            <p v-if="isInfant" class="group-hover:text-white">{{ tooth.infantToothNumber }}</p>
            <input type="checkbox" v-model="missingTeeth" :value="tooth.toothNumber" />
          </li>
        </ul>
        <ul class="flex flex-row justify-center w-full mt-3" v-show="isLowerJawVisible">
          <li
        ...
        >
          <div class="grid grid-cols-3">
            <span></span>
            <div class="flex flex-row justify-center justify-self-center items-center">
              <ChevronLeftIcon
                ...
                <div class="mt-1 w-40 relative">
                  ...
                  >
                    <span class="flex items-center">
                      <span class="ml-3 block truncate">{{ selected.charting_date }}</span>
                    </span>
                    <span
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <li
                          :class="[active ? 'text-white bg-theme-36' : 'text-gray-900', 'cursor-default select-none relative py-2 pl-3 pr-9']"
                        >
                          ...
                          <span
                            v-if="selected"
                            :class="[active ? 'text-white' : 'text-theme-36', 'absolute inset-y-0 right-0 flex items-center pr-4']"
                          >
              ...
              <ChevronRightIcon
                ...
                @click="nextButton"
                :disabled="selectedHistoryChartdate.value !== viewHistoryChartDateLength - 1"
              />
            </div>
            <XCircleIcon
      ...
      >
        ...
        <div class="flex flex-col items-center text-xs text-black space-y-5">
          ...
          <div class="my-3 rounded-b-md flex flex-col items-center">
            <EyeIcon class="text-theme-36 h-6 w-6" />Dental
          </div>
        </div>
    ...
    >
      <ul class="flex flex-col divide-y rounded w-48 bg-white shadow-sm p-0.5">
        <li class="group relative inline-block">
          <div @click="selectContextMenuItem('diagnosis')" class="context-menu-item">
...
// import ppsProbing from '@/components/patients/pps/ppsProbing.vue';

const store = useStore()

// const treatmentBlob = {}; // ('treatmentBlob');
...
const historyChartingDates = [
  {
    id: 1,
    charting_date: 'Jun 22, 2022'
  },
  {
    id: 2,
    charting_date: 'Apr 18, 2022'
  },
  {
    id: 3,
    charting_date: 'Mar 03, 2022'
  }
]
