      ...
      <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
        ...
        <div class="intro-y box lg:mt-5">
          <div
            ...
            "
          >
            <h2 class="font-medium text-base mr-auto">Email Verification</h2>
          </div>
                  ...
                  <div class="grid grid-cols-12 gap-x-5">
                    <div class="col-span-12 2xl:col-span-6">
                      ...
                      <div>
                        ...
                        >
                          Enter a verification Code we sent to your email
...
export default defineComponent({
  ...
  data() {
    ...
    const verifyEmail = () => {
      ...
      data.append('phone_verification_code', this.phone_verification_code)
      console.log('entered code' + this.phone_verification_code)
      console.log('user' + this.$store.state.auth.user.id)
      // const notification = document.querySelector(
      //   '.toastify-content .notification-message'
      // )
      AuthService.verifyEmail(this.$store.state.auth.user.id, data)
        .then((data) => {
          this.loading = false
          if (data.success) {
